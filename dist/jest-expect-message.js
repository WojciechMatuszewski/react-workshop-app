  ...
  const newMatcher = (...args) => {
    try {
      ...
      throw new JestAssertionError({ ...matcherResult,
        message: () => `🚨  ${_chalk.default.red(customMessage)}\n\n${matcherResult.message()}`
      }, newMatcher);
    }
  };
...
let expectProxy = Object.assign((actual, customMessage) => wrapMatchers(originalExpect(actual), customMessage), // partially apply expect to get all matchers and chain them
